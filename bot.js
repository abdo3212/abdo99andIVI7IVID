...
client.on("message", message => {
 ...
 ╚[❖════════════❖]╝
  ...
  ❖+np:معرفة الاغنية الشغالة الحين

  ❖ملاحظة انا اتبرا من ذنوب كل واحد يستخدم بوت الاغاني وانت تتحمل الذنوب اذا مارضيت لاتستخدم الاغاني
  ...
  ╚[❖════════════❖]╝
   ...
   ❖+bplus:لارسال برودكاست مطور

   ❖+cc:لعمل رتبة مع اختيار رقم اللون 
  ╔[❖════════════❖]╗
   General  Commands
  ╚[❖════════════❖]╝
 ...
 ╚[❖════════════❖]╝
  ...
  'welcome' لو تبي تفعل خاصية تم دعوتك بواسطة خلي اسم الروم الترحيب 
  ==================================================================
